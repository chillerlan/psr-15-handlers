...
class PriorityQueueRequestHandlerTest extends TestCase{
	...
	public function testHandler():void{
		...
		$handler = new PriorityQueueDispatcher($this->emptyResponseHandler, $middlewareStack);
	...
	public function testNestedHandler():void{
		...
		$middlewareStack = [
			new PriorityMiddleware(
				new PriorityQueueDispatcher($this->emptyResponseHandler, [
	...
	public function testInvalidMiddlewareException():void{
		...
		new PriorityQueueDispatcher($this->emptyResponseHandler, ['foo']);
	}
